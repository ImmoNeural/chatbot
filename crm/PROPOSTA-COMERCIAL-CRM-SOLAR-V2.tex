...
\begin{center}
\begin{tabular}{|c|p{7cm}|r|}
\hline
\rowcolor{primary!20}
\textbf{Selecionar} & \textbf{Módulo} & \textbf{Investimento} \\
\hline
\CheckBox[name=opt_espanhol, width=0.5cm]{} & Tradução Espanhol & R\$ 5.000,00 \\
\hline
\CheckBox[name=opt_eletromobilidade, width=0.5cm]{} & Eletromobilidade & R\$ 15.000,00 \\
\hline
\rowcolor{yellow!20}
\CheckBox[name=opt_combo, width=0.5cm]{} & \textbf{Combo (ambos com 10\% desc.)} & \textbf{R\$ 18.000,00} \\
\hline
\end{tabular}
\end{center}
