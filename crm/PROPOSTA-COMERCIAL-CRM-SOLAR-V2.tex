...
% Imagem de campo solar (baixar antes: curl -o solar-field.jpg "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800")
\begin{center}
...
\hline
CRM Solar completo com todas as funcionalidades & \\
\hline
Chatbot de qualificação de leads & \\
\hline
Kanban semi-automático & \\
\hline
Download de dados/documentos & \\
\hline
Multi-tenant (SaaS) & \\
\hline
Integração WhatsApp API & \\
\hline
Suporte 90 dias + 8h treinamento & \\
\hline
\rowcolor{yellow!20}
...
\hline
APIs + Infraestrutura & < US\$ 60/mês ($\sim$R\$ 360) \\
\hline
\end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{0.9\textwidth}{|l|c|c|l|}
\hline
\rowcolor{primary!20}
\textbf{Parcela} & \textbf{Percentual} & \textbf{Valor} & \textbf{Vencimento} \\
\hline
Sinal & 15\% & R\$ 4.500,00 & No ato da assinatura \\
\hline
\rowcolor{yellow!20}
Parcela Final & 85\% & R\$ 25.500,00 & 31 de Janeiro de 2026 \\
\hline
\end{tabularx}
\end{center}
