...
\hline
\rowcolor{primary!20}
\textbf{Sel.} & \textbf{Módulo} & \textbf{Valor} & \textbf{Total c/ Base} \\
\hline
\CheckBox[name=opt_espanhol, width=0.5cm]{} & Tradução Espanhol & R\$ 5.000 & R\$ 35.000 \\
\hline
\CheckBox[name=opt_eletromobilidade, width=0.5cm]{} & Eletromobilidade & R\$ 15.000 & R\$ 45.000 \\
\hline
\rowcolor{yellow!20}
\CheckBox[name=opt_combo, width=0.5cm]{} & Combo (ambos com 10\% desc.) & R\$ 18.000 & R\$ 48.000 \\
\hline
\end{tabular}
\end{center}

\vspace{0.5em}
\textit{Marque a opção desejada. O valor total será: Base (R\$ 30.000) + Módulo selecionado.}
...
\hline
Sistema Base (todas funcionalidades) & R\$ 30.000,00 \\
\hline
+ Tradução Espanhol (opcional) & R\$ 5.000,00 \\
\hline
+ Eletromobilidade (opcional) & R\$ 15.000,00 \\
\hline
+ Combo com 10\% desc. (opcional) & R\$ 18.000,00 \\
\hline
\rowcolor{green!20}
\textbf{TOTAL (preencher):} & \TextField[name=total_final, width=3.5cm, backgroundcolor=green!20, charsize=12pt]{} \\
\hline
\end{tabular}
\end{center}
...
\hline
Sinal & 15\% & \TextField[name=valor_sinal, width=2.5cm, backgroundcolor=white, charsize=10pt]{} & No ato da assinatura \\
\hline
\rowcolor{yellow!20}
Parcela Final & 85\% & \TextField[name=valor_final, width=2.5cm, backgroundcolor=yellow!20, charsize=10pt]{} & 31 de Janeiro de 2026 \\
\hline
\end{tabular}
\end{center}

\textit{Exemplo: Para Sistema Base (R\$ 30.000): Sinal = R\$ 4.500 | Final = R\$ 25.500}
...
\vspace{1em}
\begin{center}
\textit{\small Este documento pode ser assinado eletronicamente.}
\end{center}
