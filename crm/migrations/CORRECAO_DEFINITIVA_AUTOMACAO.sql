-- ============================================
-- CORREÇÃO DEFINITIVA - AUTOMAÇÃO DE LEADS
-- ============================================
-- Este arquivo corrige TODAS as funções para usar
-- a coluna correta: data_ultima_tentativa
-- ============================================

-- 1️⃣ DELETAR TODAS AS FUNÇÕES ANTIGAS
-- ============================================
...
-- 2️⃣ RECRIAR FUNÇÃO: detectar_leads_para_nutricao
-- ============================================
-- Lead qualificado + 7-14 dias sem interação + motivo_espera preenchido
-- ============================================
...
-- 3️⃣ RECRIAR FUNÇÃO: detectar_leads_perdidos
-- ============================================
-- ⚠️ CORREÇÃO CRÍTICA: Usa data_ultima_tentativa ao invés de última interação
-- ============================================
...
BEGIN
    ...
    SELECT
        ...
        l.email::TEXT,
        EXTRACT(DAY FROM NOW() - COALESCE(
            l.data_ultima_tentativa,  -- ✅ USA ESTA COLUNA (não ultima interação!)
            l.created_at
        ))::INTEGER as dias,
...
-- 4️⃣ RECRIAR FUNÇÃO: detectar_oportunidades_perdidas
-- ============================================
...
-- 5️⃣ RECRIAR FUNÇÃO: mover_para_nutricao
-- ============================================
...
-- 6️⃣ RECRIAR FUNÇÃO: marcar_como_perdido
-- ============================================
...
-- 7️⃣ RECRIAR FUNÇÃO: reverter_mudanca_automatica
-- ============================================
...
-- 8️⃣ RECRIAR FUNÇÃO PRINCIPAL: executar_automacao_leads
-- ============================================
...
SELECT '✅ ETAPA 1: Funções recriadas com sucesso!' as status;

-- Verificar se todas as 7 funções foram criadas
SELECT '✅ ETAPA 2: Verificando funções...' as status;
...
-- Testar detecção de leads perdidos (deve encontrar Rogerio)
SELECT '✅ ETAPA 3: Testando detecção de leads perdidos...' as status;
SELECT * FROM detectar_leads_perdidos();

-- Mostrar estatísticas
SELECT '✅ ETAPA 4: Estatísticas de candidatos...' as status;
...
SELECT '✅ PRONTO! Agora execute: SELECT executar_automacao_leads();' as status;
