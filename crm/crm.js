...
function verMemoriaCalculo(propostaIndex) {
    ...
    const html = `
        <div class="max-w-5xl mx-auto bg-gradient-to-br from-blue-50 via-white to-green-50 p-1 rounded-2xl shadow-2xl">
        <div class="bg-white p-8 rounded-xl">
            <!-- CABEÇALHO -->
            <div class="text-center mb-8 pb-6 border-b-4 border-gradient-to-r from-blue-500 to-green-500" style="border-image: linear-gradient(to right, #3b82f6, #10b981) 1;">
                ...
                <h2 class="text-xl font-semibold text-gray-700">Sistema de Energia Solar Fotovoltaica</h2>
                <p class="text-sm text-gray-500 mt-2">Sunbotic Energia Solar | ${new Date().toLocaleDateString('pt-BR')}</p>
            </div>

            <!-- 1. LOCALIZAÇÃO E DADOS CLIMÁTICOS -->
            <div class="mb-8 bg-gradient-to-r from-blue-50 to-cyan-50 p-6 rounded-xl border-l-4 border-blue-500">
                <h3 class="text-xl font-bold mb-4 text-blue-800">
                    <i class="fas fa-map-marker-alt mr-2"></i>1. LOCALIZAÇÃO E DADOS CLIMÁTICOS
                </h3>
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">Cidade:</span>
                        <strong class="text-lg">${resultado.localizacao.cidade}</strong>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">Estado:</span>
                        <strong class="text-lg">${resultado.localizacao.estado}</strong>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">Bairro:</span>
                        <strong class="text-lg">${resultado.localizacao.bairro || 'N/A'}</strong>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">☀️ Irradiação Solar (HSP):</span>
                        <strong class="text-lg text-orange-600">${resultado.localizacao.irradiacao} kWh/m²/dia</strong>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">📐 Inclinação Telhado:</span>
                        <strong class="text-lg">${resultado.dimensionamento.inclinacao || 15}°</strong>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">🧭 Azimute (Orientação):</span>
                        <strong class="text-lg">${resultado.dimensionamento.azimute || 0}° (Norte)</strong>
                    </div>
                    <div class="bg-white p-3 rounded-lg shadow-sm col-span-2">
                        <span class="text-gray-600 block">⚙️ Tipo de Sistema:</span>
                        <strong class="text-lg text-green-600">${tipoSistema === 'on-grid' ? 'On-Grid (Conectado à Rede)' : tipoSistema === 'off-grid' ? 'Off-Grid (Isolado)' : 'Híbrido'}</strong>
                    </div>
                </div>
            </div>

            <!-- 2. DIMENSIONAMENTO DO SISTEMA -->
            <div class="mb-8 bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border-l-4 border-green-500">
                <h3 class="text-xl font-bold mb-4 text-green-800">
                    <i class="fas fa-solar-panel mr-2"></i>2. DIMENSIONAMENTO DO SISTEMA
                </h3>
                <div class="grid grid-cols-2 gap-4 text-sm mb-4">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">Consumo Mensal Desejado:</span>
                        <strong class="text-2xl text-green-600">${resultado.dimensionamento.energiaMensalNecessaria} kWh</strong>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">Potência Instalada:</span>
                        <strong class="text-2xl text-blue-600">${configuracao.potenciaRealKwp} kWp</strong>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">Número de Módulos:</span>
                        <strong class="text-2xl">${configuracao.numModulos} placas</strong>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <span class="text-gray-600 block">Área Total Necessária:</span>
                        <strong class="text-2xl">${configuracao.area.toFixed(1)} m²</strong>
                    </div>
                </div>

                <div class="bg-white p-4 rounded-lg shadow-sm">
                    <h4 class="font-bold text-green-700 mb-2">📋 Equipamentos Selecionados:</h4>
            ...
            <!-- 3. PERDAS DO SISTEMA -->
            <div class="mb-8 bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-xl border-l-4 border-orange-500">
                <h3 class="text-xl font-bold mb-4 text-orange-800">
                    <i class="fas fa-exclamation-triangle mr-2"></i>3. PERDAS DO SISTEMA
                </h3>
                <div class="bg-white p-4 rounded-lg shadow-sm">
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b-2 border-orange-200">
                                <th class="text-left py-2">Tipo de Perda</th>
                                <th class="text-right py-2">Percentual</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b"><td class="py-2">🌡️ Temperatura dos módulos</td><td class="text-right">8%</td></tr>
                            <tr class="border-b"><td class="py-2">⚡ Inversor (conversão DC/AC)</td><td class="text-right">3%</td></tr>
                            <tr class="border-b"><td class="py-2">🔌 Cabeamento (DC + AC)</td><td class="text-right">1.5%</td></tr>
                            <tr class="border-b"><td class="py-2">🌳 Sombreamento</td><td class="text-right">2%</td></tr>
                            <tr class="border-b"><td class="py-2">💨 Poeira e sujeira</td><td class="text-right">2%</td></tr>
                            <tr class="border-b"><td class="py-2">⚠️ Mismatch (descasamento)</td><td class="text-right">1.5%</td></tr>
                            <tr class="bg-orange-100 font-bold">
                                <td class="py-2">TOTAL DE PERDAS</td>
                                <td class="text-right text-orange-700">≈ 18%</td>
                            </tr>
                        </tbody>
                    </table>
                    <p class="text-xs text-gray-600 mt-2">* Perdas consideradas no dimensionamento para garantir geração adequada</p>
                </div>
            </div>

            <!-- 4. DIMENSIONAMENTO ELÉTRICO -->
            <div class="mb-8 bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border-l-4 border-purple-500">
                <h3 class="text-xl font-bold mb-4 text-purple-800">
                    <i class="fas fa-bolt mr-2"></i>4. DIMENSIONAMENTO ELÉTRICO
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <h4 class="font-bold text-purple-700 mb-3">Lado DC (Corrente Contínua)</h4>
                        <ul class="text-sm space-y-2">
                            ...
                            <li><strong>Seccionador DC:</strong> ${protecoes.seccionadorDC || 'Incluso'}</li>
                        </ul>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <h4 class="font-bold text-purple-700 mb-3">Lado AC (Corrente Alternada)</h4>
                        <ul class="text-sm space-y-2">
                            ...
                            <li><strong>SPD (Proteção Surtos):</strong> Classe II - DC e AC</li>
                            <li><strong>Aterramento:</strong> Conforme NBR 5410</li>
                        </ul>
                    </div>
                </div>
            </div>

            <!-- 5. CUSTOS DE MATERIAIS -->
            <div class="mb-8 bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border-l-4 border-yellow-500">
                <h3 class="text-xl font-bold mb-4 text-yellow-800">
                    <i class="fas fa-box mr-2"></i>5. CUSTOS DE MATERIAIS
                </h3>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4">
                                    <strong>Placas Solares</strong><br>
                                    <small class="text-gray-600">${configuracao.numModulos}x ${configuracao.placa.fabricante} ${configuracao.placa.potencia}Wp</small>
                                </td>
                                <td class="py-3 px-4 text-right font-semibold">${formatCurrency(custos.materiais.placas)}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4">
                                    <strong>Inversor</strong><br>
                                    <small class="text-gray-600">${inversor.fabricante} ${inversor.potencia_kw}kW</small>
                                </td>
                                <td class="py-3 px-4 text-right font-semibold">${formatCurrency(custos.materiais.inversor)}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>Estrutura de Fixação</strong></td>
                                <td class="py-3 px-4 text-right font-semibold">${formatCurrency(custos.materiais.estrutura)}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>Cabos DC (${cabosDC.secao || 6}mm²)</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.materiais.cabosDC || 0)}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>Cabos AC (${cabosAC.secao || 6}mm²)</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.materiais.cabosAC || 0)}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>Conectores e Eletrodutos</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency((custos.materiais.conectores || 0) + (custos.materiais.eletrodutos || 0))}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>String Box</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.materiais.stringBox || 0)}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>Disjuntores DC e AC</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency((custos.materiais.disjuntorDC || 0) + (custos.materiais.disjuntorAC || 0))}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>SPD (Proteção contra Surtos)</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.materiais.spd || 0)}</td>
                            </tr>
                            <tr class="border-b hover:bg-yellow-50">
                                <td class="py-3 px-4"><strong>Seccionadores</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.materiais.seccionadores || 0)}</td>
                            </tr>
                            <tr class="bg-yellow-200 font-bold text-lg">
                                <td class="py-4 px-4">SUBTOTAL MATERIAIS</td>
                                <td class="py-4 px-4 text-right text-yellow-800">${formatCurrency(custos.materiais.total)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <!-- 6. CUSTOS DE SERVIÇOS -->
            <div class="mb-8 bg-gradient-to-r from-teal-50 to-cyan-50 p-6 rounded-xl border-l-4 border-teal-500">
                <h3 class="text-xl font-bold mb-4 text-teal-800">
                    <i class="fas fa-tools mr-2"></i>6. CUSTOS DE SERVIÇOS
                </h3>
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <tr class="border-b hover:bg-teal-50">
                                <td class="py-3 px-4"><strong>Mão de Obra (Instalação)</strong></td>
                                <td class="py-3 px-4 text-right font-semibold">${formatCurrency(custos.servicos.maoObra)}</td>
                            </tr>
                            <tr class="border-b hover:bg-teal-50">
                                <td class="py-3 px-4"><strong>Projeto Elétrico</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.servicos.projeto || 0)}</td>
                            </tr>
                            <tr class="border-b hover:bg-teal-50">
                                <td class="py-3 px-4"><strong>ART (Anotação de Responsabilidade Técnica)</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.servicos.art || 0)}</td>
                            </tr>
                            <tr class="border-b hover:bg-teal-50">
                                <td class="py-3 px-4"><strong>Homologação na Concessionária</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.servicos.homologacao)}</td>
                            </tr>
                            <tr class="border-b hover:bg-teal-50">
                                <td class="py-3 px-4"><strong>Deslocamento</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.servicos.deslocamento || 0)}</td>
                            </tr>
                            <tr class="border-b hover:bg-teal-50">
                                <td class="py-3 px-4"><strong>Ferramentas e EPI</strong></td>
                                <td class="py-3 px-4 text-right">${formatCurrency(custos.servicos.ferramentasEPI || 0)}</td>
                            </tr>
                            <tr class="bg-teal-200 font-bold text-lg">
                                <td class="py-4 px-4">SUBTOTAL SERVIÇOS</td>
                                <td class="py-4 px-4 text-right text-teal-800">${formatCurrency(custos.servicos.total)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="mb-8 bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border-l-4 border-green-600 shadow-lg">
                <h3 class="text-xl font-bold mb-4 text-green-800">
                    <i class="fas fa-calculator mr-2"></i>7. COMPOSIÇÃO DE PREÇO
                </h3>
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    <table class="w-full text-sm">
                        <tbody>
                            <tr class="border-b hover:bg-green-50">
                                <td class="py-4 px-4 font-semibold">Materiais</td>
                                <td class="py-4 px-4 text-right font-semibold">${formatCurrency(custos.materiais.total)}</td>
                            </tr>
                            <tr class="border-b hover:bg-green-50">
                                <td class="py-4 px-4 font-semibold">Serviços</td>
                                <td class="py-4 px-4 text-right font-semibold">${formatCurrency(custos.servicos.total)}</td>
                            </tr>
                            <tr class="bg-blue-100 border-b-2">
                                <td class="py-4 px-4 font-bold text-lg">CUSTO TOTAL DO PROJETO</td>
                                <td class="py-4 px-4 text-right font-bold text-blue-700 text-xl">${formatCurrency(custos.custoTotal)}</td>
                            </tr>
                            <tr class="border-b hover:bg-green-50">
                                <td class="py-4 px-4 font-semibold text-green-700">Margem de Lucro (${custos.margemPercentual}%)</td>
                                <td class="py-4 px-4 text-right font-semibold text-green-700 text-lg">+ ${formatCurrency(custos.lucro)}</td>
                            </tr>
                            <tr class="bg-gradient-to-r from-green-500 to-emerald-600 text-white">
                                <td class="py-5 px-4 font-bold text-xl">VALOR DE VENDA</td>
                                <td class="py-5 px-4 text-right font-bold text-3xl">${formatCurrency(custos.valorVenda)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="mb-8 bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-xl border-l-4 border-indigo-500">
                <h3 class="text-xl font-bold mb-4 text-indigo-800">
                    <i class="fas fa-chart-line mr-2"></i>8. ANÁLISE FINANCEIRA E RETORNO
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <h4 class="font-bold text-indigo-700 mb-3">💰 Economia do Cliente</h4>
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between border-b pb-2">
                                <span>Economia Mensal:</span>
                                <strong class="text-green-600 text-lg">${formatCurrency(economia.economiaMensal)}</strong>
                            </div>
                            <div class="flex justify-between border-b pb-2">
                                <span>Economia Anual:</span>
                                <strong class="text-green-600 text-lg">${formatCurrency(economia.economiaAnual)}</strong>
                            </div>
                            <div class="flex justify-between border-b pb-2">
                                <span>Em 25 anos:</span>
                                <strong class="text-green-600 text-xl">${formatCurrency(economia.economia25Anos)}</strong>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        <h4 class="font-bold text-indigo-700 mb-3">📊 Indicadores Financeiros</h4>
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between border-b pb-2">
                                <span>Payback (Retorno):</span>
                                <strong class="text-blue-600 text-xl">${paybackAnos} anos</strong>
                            </div>
                            ${tir > 0 ? `<div class="flex justify-between border-b pb-2">
                                <span>TIR (Taxa Retorno):</span>
                                <strong class="text-purple-600 text-lg">${tir}% a.a.</strong>
                            </div>` : ''}
                            ${vpl && vpl !== 0 ? `<div class="flex justify-between border-b pb-2">
                                <span>VPL (Valor Presente):</span>
                                <strong class="text-indigo-600 text-lg">${formatCurrency(vpl)}</strong>
                            </div>` : ''}
                        </div>
                    </div>
                </div>
            ...
            <!-- RESUMO PARA O INTEGRADOR -->
            <div class="bg-gradient-to-r from-amber-400 via-yellow-500 to-orange-500 text-white p-6 rounded-xl shadow-xl mb-8">
                <h3 class="font-bold text-2xl mb-4 text-center">
                    <i class="fas fa-business-time mr-2"></i>RESUMO FINANCEIRO PARA O INTEGRADOR
                </h3>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm p-4 rounded-lg text-center">
                        <span class="text-sm opacity-90 block mb-1">Custo do Projeto</span>
                        <strong class="text-2xl block">${formatCurrency(custos.custoTotal)}</strong>
                    </div>
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm p-4 rounded-lg text-center">
                        <span class="text-sm opacity-90 block mb-1">Lucro Bruto</span>
                        <strong class="text-2xl block">${formatCurrency(custos.lucro)}</strong>
                    </div>
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm p-4 rounded-lg text-center">
                        <span class="text-sm opacity-90 block mb-1">Margem</span>
                        <strong class="text-3xl block">${custos.margemPercentual}%</strong>
                    </div>
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm p-4 rounded-lg text-center">
                        <span class="text-sm opacity-90 block mb-1">Valor de Venda</span>
                        <strong class="text-2xl block">${formatCurrency(custos.valorVenda)}</strong>
                    </div>
                </div>
            </div>

            <!-- RODAPÉ -->
            <div class="text-center text-sm text-gray-600 mt-8 pt-6 border-t-2 border-gray-200">
                <p class="font-bold text-lg mb-2">Sunbotic Energia Solar</p>
                <p>Memorial Técnico gerado em: ${new Date().toLocaleString('pt-BR')}</p>
                <p class="mt-2 text-xs">Documento interno - Uso exclusivo da empresa integradora</p>
                <p class="text-xs text-gray-500 mt-1">Sistema dimensionado conforme NBR 16690 e NBR 5410</p>
            </div>
        </div>
        </div>
    `;
    ...
    printWindow.document.write(`
        <html>
        <head>
            <title>Memorial Técnico - ${configuracao.placa.fabricante} - ${resultado.localizacao.cidade}</title>
        ...
        <body>
            ...
            <div class="text-center mt-8 no-print">
                <button onclick="window.print()" class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-lg text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all">
                    <i class="fas fa-print mr-2"></i>Imprimir / Salvar PDF
                </button>
                <button onclick="window.close()" class="bg-gray-600 text-white px-8 py-3 rounded-lg text-lg ml-4 hover:bg-gray-700 transition-all">
...
async function gerarPropostaComercial(propostaIndex) {
    ...
    const html = `
        <div class="max-w-5xl mx-auto bg-gradient-to-br from-green-50 via-white to-emerald-50 p-1 rounded-2xl shadow-2xl">
        <div class="bg-white p-8 rounded-xl">
            <div class="text-center mb-8 pb-6 border-b-4" style="border-image: linear-gradient(to right, #10b981, #059669) 1;">
                <h1 class="text-4xl font-bold bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent mb-2">
                    💚 PROPOSTA COMERCIAL
                </h1>
                <h2 class="text-xl font-semibold text-gray-700">Sistema de Energia Solar Fotovoltaica</h2>
                <p class="text-gray-600 mt-2">Sunbotic Energia Solar | ${new Date().toLocaleDateString('pt-BR')}</p>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div class="flex items-center"><i class="fas fa-check text-green-500 mr-2"></i>Garantia de 5 anos nos módulos (25 anos de performance)</div>
                </div>
            </div>
    ...
    printWindow.document.write(`
        <html>
        <head>
            <title>Proposta Comercial - ${resultado.localizacao.cidade} - ${configuracao.placa.fabricante}</title>
            <link href="https://cdn.tailwindcss.com" rel="stylesheet">
            <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
            <style>
                @media print {
        ...
        <body>
            ${html}
            <div class="text-center mt-8 no-print">
                <button onclick="window.print()" class="bg-gradient-to-r from-green-600 to-emerald-700 text-white px-8 py-3 rounded-lg text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all">
                    <i class="fas fa-print mr-2"></i>Imprimir / Salvar PDF
                </button>
