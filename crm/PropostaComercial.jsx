                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-12 border border-green-200">
                    ...
                    <section className="mb-10 bg-gradient-to-r from-green-50/80 to-emerald-50/80 p-8 rounded-xl border border-green-200/50">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-white/90 p-4 rounded-lg shadow-sm">
                                <span className="text-slate-600 text-sm block mb-1">Localização</span>
                            ...
                            <div className="bg-white/90 p-4 rounded-lg shadow-sm">
                                <span className="text-slate-600 text-sm block mb-1">☀️ Irradiação Solar</span>
                    ...
                    <section className="mb-10 bg-gradient-to-r from-blue-50/80 to-cyan-50/80 p-8 rounded-xl border border-blue-200/50">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            <div className="bg-white/90 p-5 rounded-lg shadow-sm text-center">
                                <span className="text-slate-600 block mb-2">Potência Total</span>
                            ...
                            <div className="bg-white/90 p-5 rounded-lg shadow-sm text-center">
                                <span className="text-slate-600 block mb-2">Geração Mensal Estimada</span>
                        ...
                        <div className="bg-white/90 p-5 rounded-lg shadow-sm">
                            <div className="space-y-3 text-sm text-slate-700">
                                <div className="flex items-start">
                                    <span className="font-semibold min-w-[140px]">Módulos:</span>
                                ...
                                <div className="flex items-start">
                                    <span className="font-semibold min-w-[140px]">Área Necessária:</span>
                                    <span>{configuracao.area.toFixed(1)} m²</span>
                                </div>
                                <div className="flex items-start">
                                    <span className="font-semibold min-w-[140px]">Garantia:</span>
                                    <span>5 anos nos módulos (25 anos de performance ≥80%)</span>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-10 bg-gradient-to-r from-slate-50/80 to-gray-50/80 p-8 rounded-xl border border-slate-200/50">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                            {[
                                ...
                                'Garantia de 5 anos nos módulos (25 anos de performance)'
                            ].map((item, index) => (
                    ...
                    <section className="mb-10 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 p-8 rounded-xl border border-blue-200/50">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {vpl && vpl !== 0 && (
                                <div className="bg-white/90 p-6 rounded-lg shadow-sm col-span-2">
                                    <span className="text-slate-600 block mb-2">VPL (Valor Presente Líquido)</span>
                                    <strong className="text-4xl text-indigo-700">{formatCurrency(vpl)}</strong>
                                    <p className="text-xs text-slate-500 mt-2">Ganho total atualizado em 25 anos</p>
                                </div>
                            )}
                        </div>
                    </section>
                    ...
                    <section className="mb-10 bg-gradient-to-r from-amber-50/80 to-yellow-50/80 p-8 rounded-xl border-2 border-amber-300/50 shadow-lg">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-sm text-slate-600 mt-2">À vista ou parcelado (consultar condições)</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-10 bg-slate-100/80 p-6 rounded-xl border border-slate-300/50">
                        ...
                        <ul className="text-sm text-slate-700 space-y-1 list-disc list-inside">
                            ...
                            <li>Garantia do fabricante: 5 anos para módulos e inversor</li>
                    ...
                    <div className="text-center text-sm text-slate-600 pt-8 border-t-2 border-slate-200">
                        ...
                        <p className="text-xs text-slate-500 mt-2">Este documento é uma proposta comercial. O projeto executivo será elaborado após aprovação.</p>
                    </div>
                </div>
